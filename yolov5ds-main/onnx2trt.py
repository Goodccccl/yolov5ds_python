...
import sys
'''
onnx 转 trt文件 为了在 Jetson AGX Xavier 上进行预测
需要修改 model_path  engine_file_path 就可以实现 onnx 转 trt
'''
TRT_LOGGER = trt.Logger()
model_path = r'D:\Artificial neural Network\yolov5ds-main\yolov5ds-main\runs\train\exp\weights\best.onnx'
engine_file_path = r"D:\Artificial neural Network\yolov5ds-main\yolov5ds-main\runs\train\exp\weights\best.trt"
